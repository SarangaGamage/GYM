exports.success = (response, data = {}, message="Success") => {
  ...
  exports.unauthorized = (response, message="Invalid token has been detected!") => {
  ...
  exports.serverError = (response, message = "Oops! Something went wrong internally. Please try again later.") => {
